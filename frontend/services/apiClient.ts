...
const BASE_URL = Constants.expoConfig?.extra?.apiBaseUrl || "http://localhost:3001";

// Global token storage for React Native (managed by AuthContext or similar)
...
// Default API client instance - token will be set via setApiToken()
export const api = new ApiClient({
  baseUrl: BASE_URL,
  getToken: () => currentToken,
});

// Helper to create a custom API client with specific options

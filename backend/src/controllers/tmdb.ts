...
=======
    ...
    vote_average?: number;
    spoken_languages?: Array<{ english_name?: string }>;
>>>>>>> 1ec8dd9 (added delete and updating via local id functions)
};
...
=======
    const existing = await prisma.movie.findFirst({
        where: { // idk if this is the best way to do this, should search by smth thats unique -amogh
            title: mapped.title,
            description: mapped.description,
        },
    });
...
// TODO: Implement the following - amogh

// GET /movies/local/:movieId

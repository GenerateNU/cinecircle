...
INSERT INTO "public"."UserProfile" (
  ...
  ('11111111-1111-1111-1111-111111111111', 'alice_movie_fan', ARRAY['English', 'Spanish'], ARRAY['Drama', 'Thriller'], ARRAY['tt0111161', 'tt0068646'], NOW(), NOW()),
  ('22222222-2222-2222-2222-222222222222', 'bob_cineaste', ARRAY['English', 'French'], ARRAY['Action', 'Sci-Fi'], ARRAY['tt0468569', 'tt0137523'], NOW(), NOW()),
  ('33333333-3333-3333-3333-333333333333', 'charlie_critic', ARRAY['English'], ARRAY['Comedy', 'Romance'], ARRAY['tt0109830', 'tt1375666'], NOW(), NOW()),
  ('44444444-4444-4444-4444-444444444444', 'diana_director', ARRAY['English', 'Italian'], ARRAY['Drama', 'Biography'], ARRAY['tt0073486', 'tt0099685'], NOW(), NOW()),
  ('55555555-5555-5555-5555-555555555555', 'evan_enthusiast', ARRAY['English', 'Japanese'], ARRAY['Animation', 'Fantasy'], ARRAY['tt0245429', 'tt1853728'], NOW(), NOW()),
  ('66666666-6666-6666-6666-666666666666', 'fiona_film_buff', ARRAY['English', 'German'], ARRAY['Horror', 'Mystery'], ARRAY['tt0816692', 'tt0110912'], NOW(), NOW()),
...
INSERT INTO "public"."movie" (
  ...
  ('tt0111161', 'The Shawshank Redemption', 'Two imprisoned men bond over a number of years.', '9.2', 9300000, '["English"]', '120'),
  ('tt0068646', 'The Godfather', 'The aging patriarch of an organized crime dynasty transfers control.', '9.1', 9200000, '["English", "Italian"]', '98'),
  ('tt0468569', 'The Dark Knight', 'Batman must accept one of the greatest psychological tests.', '8.9', 9000000, '["English"]', '145'),
  ('tt0137523', 'Fight Club', 'An insomniac office worker forms an underground fight club.', '8.7', 8800000, '["English"]', '89'),
  ('tt0109830', 'Forrest Gump', 'The presidencies of Kennedy and Johnson unfold through the perspective of an Alabama man.', '8.8', 8800000, '["English"]', '103'),
  ('tt1375666', 'Inception', 'A thief who steals corporate secrets through dream-sharing technology.', '8.7', 8800000, '["English", "French", "Japanese"]', '156'),
  ('tt0073486', 'One Flew Over the Cuckoo''s Nest', 'A criminal pleads insanity and is admitted to a mental institution.', '8.6', 8700000, '["English"]', '67'),
  ('tt0099685', 'Goodfellas', 'The story of Henry Hill and his life in the mob.', '8.6', 8700000, '["English", "Italian"]', '78'),
  ('tt0245429', 'Spirited Away', 'A young girl enters a world ruled by gods and witches.', '8.5', 8600000, '["Japanese"]', '92'),
  ('tt1853728', 'Django Unchained', 'With the help of a German bounty hunter, a freed slave seeks revenge.', '8.4', 8500000, '["English"]', '85'),
  ('tt0816692', 'Interstellar', 'A team of explorers travel through a wormhole in space.', '8.6', 8700000, '["English"]', '134'),
  ('tt0110912', 'Pulp Fiction', 'The lives of two mob hitmen, a boxer, and a pair of diner bandits intertwine.', '8.8', 8900000, '["English"]', '156'),
  ('tt0076759', 'Star Wars', 'Luke Skywalker joins forces to save Princess Leia.', '8.5', 8600000, '["English"]', '167'),
  ('tt0050083', '12 Angry Men', 'A jury holdout attempts to prevent a miscarriage of justice.', '8.9', 9000000, '["English"]', '54'),
  ('tt6751668', 'Parasite', 'Greed and class discrimination threaten the symbiotic relationship.', '8.5', 8600000, '["Korean"]', '98'),
  ('tt0167260', 'The Lord of the Rings: The Return of the King', 'Gandalf and Aragorn lead the World of Men against Sauron.', '8.9', 9000000, '["English"]', '189'),
  ('tt0114369', 'Se7en', 'Two detectives hunt a serial killer who uses the seven deadly sins.', '8.6', 8600000, '["English"]', '76'),
  ('tt0120737', 'The Lord of the Rings: The Fellowship of the Ring', 'A meek Hobbit sets out to destroy the One Ring.', '8.8', 8800000, '["English"]', '145'),
  ('tt0133093', 'The Matrix', 'A computer hacker learns about the true nature of his reality.', '8.7', 8700000, '["English"]', '167'),
  ('tt0088763', 'Back to the Future', 'Marty McFly is accidentally sent 30 years into the past.', '8.5', 8500000, '["English"]', '123')
